    ...
    describe('prepareLinks', () => {
        it('returns correct links for valid files', () => {
            ...
            const result = instance.prepareLinks({
                files: ['modules/ROOT/pages/page1.adoc', 'modules/module1/pages/page2.adoc', 'modules/ROOT/pages/page1.md'],
        ...
        it('handles files with mixed valid and invalid paths', () => {
            ...
            expect(result).toBe('- [ ] [page1](http://example.com/component/1.0/page1)');
        });
        ...
        it('handles files with non-ROOT module correctly', () => {
            ...
            expect(result).toBe('- [ ] [module1/page1](http://example.com/component/1.0/module1/page1)');
        });
    });
});
