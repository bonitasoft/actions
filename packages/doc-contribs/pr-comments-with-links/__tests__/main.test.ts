...
describe('comments-pr-with-links', () => {
    ...
    beforeEach(async () => {
        ...
        mockGetFilesFromPR = getFilesFromPR as jest.MockedFunction<typeof getFilesFromPR>;
        mockPublishComment = publishComment as jest.MockedFunction<typeof publishComment>;
